...
from game_file_test import Bird, PipePair
import numpy as np
from genome_test import Genome
FPS = 120
ANIMATION_SPEED = 1.5
WIN_WIDTH = 284 * 2     
WIN_HEIGHT = 512
...
class game_main():
    def __init__(self):
        ...
        pygame.init()
        pygame.display.set_caption('Flappy Bird Game test')
...
if __name__ == '__main__':
    ...
    try:
        ...
        pass
    print("Result:", test.fitness, test.score)
